...
let s:bg = '#000000'
let s:bg_alt = '#1A1A19'
let s:bg_subtle = '#181B17'
let s:bg_visual = '#1E1B19'
let s:bg_search = '#262524'
let s:bg_search_focus = '#33312F'
let s:bg_diff_add = '#181B17'
let s:bg_diff_change = '#262524'
let s:bg_diff_delete = '#1E1B19'
let s:bg_diff_text = '#33312F'

let s:fg = '#5D5B57'
let s:fg_high = '#6D7073'
let s:fg_low = '#3C3A38'
let s:fg_gutter = '#282726'

let s:red = '#6F514A'
let s:green = '#5F735C'
let s:yellow = '#5D5B57'
let s:blue = '#6D7073'
let s:magenta = '#5D5B57'
let s:cyan = '#6D7073'
let s:white = '#6D7073'
let s:accent = s:fg

let s:bright_red = '#6F514A'
let s:bright_green = '#5F735C'
let s:bright_yellow = '#6D7073'
let s:bright_blue = '#6D7073'
let s:bright_magenta = '#5D5B57'
let s:bright_cyan = '#6D7073'
