...
let s:bg = '#1738A8'
let s:bg_alt = '#2556D6'
let s:bg_subtle = '#14318E'
let s:bg_visual = '#2E74FF'
let s:bg_search = '#FFD21A'
let s:bg_search_focus = '#FFF06A'
let s:bg_diff_add = '#155A1F'
let s:bg_diff_change = '#1550C8'
let s:bg_diff_delete = '#7A1820'
let s:bg_diff_text = '#25A2FF'

let s:fg = '#F2F7FF'
let s:fg_high = '#FFFDF4'
let s:fg_low = '#A6C2FF'
let s:fg_gutter = '#6A8DDE'

let s:red = '#FF4A2A'
let s:green = '#A8F500'
let s:yellow = '#FFD21A'
let s:blue = '#6BC0FF'
let s:magenta = '#FF7AF6'
let s:cyan = '#41F2FF'
let s:white = '#FFFDF4'
let s:accent = s:yellow

let s:bright_red = '#FF6E52'
let s:bright_green = '#C8FF47'
let s:bright_yellow = '#FFF06A'
let s:bright_blue = '#8BD2FF'
let s:bright_magenta = '#FFADF8'
let s:bright_cyan = '#9BFAFF'
